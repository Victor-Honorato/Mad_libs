...
def play_mad_libs(master):
    # Função principal que cria a janela do jogo Mad Libs
...
if __name__ == "__main__":
    ...
    # Criação e exibição do menu principal
    main_menu = MainMenu(app, lambda: play_mad_libs(app), lambda: InstructionsPage(app))
